...
const Steelcase = new Product(getByDataSet("id", 1), 0);
const Insignia = new Product(getByDataSet("id", 2), 0);
const Flash = new Product(getByDataSet("id", 3), 0);
const Koble = new Product(getByDataSet("id", 4), 0);
const Serta = new Product(getByDataSet("id", 5), 0);
